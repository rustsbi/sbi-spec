...
mod tests {
    ...
    fn test_pmu() {
        ...
        const_assert_eq!(2, event_idx_type::HW_RAW);
        const_assert_eq!(15, event_idx_type::FW);

        const_assert_eq!(0, hw_event_code::NO_EVENT);
        const_assert_eq!(1, hw_event_code::CPU_CYCLES);
        const_assert_eq!(2, hw_event_code::INSTRUCTIONS);
        const_assert_eq!(3, hw_event_code::CACHE_REFERENCES);
        const_assert_eq!(4, hw_event_code::CACHE_MISSES);
        const_assert_eq!(5, hw_event_code::BRANCH_INSTRUCTIONS);
        const_assert_eq!(6, hw_event_code::BRANCH_MISSES);
        const_assert_eq!(7, hw_event_code::BUS_CYCLES);
        const_assert_eq!(8, hw_event_code::STALLED_CYCLES_FRONTEND);
        const_assert_eq!(9, hw_event_code::STALLED_CYCLES_BACKEND);
        const_assert_eq!(10, hw_event_code::REF_CPU_CYCLES);

        const_assert_eq!(0, hw_cache_id::L1D);
        const_assert_eq!(1, hw_cache_id::L1I);
        const_assert_eq!(2, hw_cache_id::LL);
        const_assert_eq!(3, hw_cache_id::DTLB);
        const_assert_eq!(4, hw_cache_id::ITLB);
        const_assert_eq!(5, hw_cache_id::BPU);
        const_assert_eq!(6, hw_cache_id::NODE);

        const_assert_eq!(0, hw_cache_op_id::READ);
        const_assert_eq!(1, hw_cache_op_id::WRITE);
        const_assert_eq!(2, hw_cache_op_id::PREFETCH);

        const_assert_eq!(0, hw_cache_op_result_id::ACCESS);
        const_assert_eq!(1, hw_cache_op_result_id::MISS);

        const_assert_eq!(0, fw_event_code::MISALIGNED_LOAD);
        const_assert_eq!(1, fw_event_code::MISALIGNED_STORE);
        const_assert_eq!(2, fw_event_code::ACCESS_LOAD);
        const_assert_eq!(3, fw_event_code::ACCESS_STORE);
        const_assert_eq!(4, fw_event_code::ILLEGAL_INSN);
        const_assert_eq!(5, fw_event_code::SET_TIMER);
        const_assert_eq!(6, fw_event_code::IPI_SENT);
        const_assert_eq!(7, fw_event_code::IPI_RECEIVED);
        const_assert_eq!(8, fw_event_code::FENCE_I_SENT);
        const_assert_eq!(9, fw_event_code::FENCE_I_RECEIVED);
        const_assert_eq!(10, fw_event_code::SFENCE_VMA_SENT);
        const_assert_eq!(11, fw_event_code::SFENCE_VMA_RECEIVED);
        const_assert_eq!(12, fw_event_code::SFENCE_VMA_ASID_SENT);
        const_assert_eq!(13, fw_event_code::SFENCE_VMA_ASID_RECEIVED);
        const_assert_eq!(14, fw_event_code::HFENCE_GVMA_SENT);
        const_assert_eq!(15, fw_event_code::HFENCE_GVMA_RECEIVED);
        const_assert_eq!(16, fw_event_code::HFENCE_GVMA_VMID_SENT);
        const_assert_eq!(17, fw_event_code::HFENCE_GVMA_VMID_RECEIVED);
        const_assert_eq!(18, fw_event_code::HFENCE_VVMA_SENT);
        const_assert_eq!(19, fw_event_code::HFENCE_VVMA_RECEIVED);
        const_assert_eq!(20, fw_event_code::HFENCE_VVMA_ASID_SENT);
        const_assert_eq!(21, fw_event_code::HFENCE_VVMA_ASID_RECEIVED);
        const_assert_eq!(65535, fw_event_code::PLATFORM);
    }
    // §12
    #[test]
    fn test_dbcn() {
